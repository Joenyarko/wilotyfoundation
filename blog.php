  ...
  <div class="blog-hero-container">
    <div class="blog-hero-featured" id="featuredHero">
      ...
      <div class="blog-hero-content">
        ...
        <a href="blog-detail.php?id=<?= $hero['id'] ?>" class="blog-hero-read-more" id="heroLink">Read more</a>
      </div>
      <?php else: ?>
      ...
      <div class="blog-hero-content">
        <h2 id="heroTitle"></h2>
        <p id="heroSummary"></p>
        <a href="#" class="blog-hero-read-more" id="heroLink">Read more</a>
      </div>
      <?php endif; ?>
      ...
      <?php if (!empty($allBlogs)): ?>
        <?php foreach ($allBlogs as $blog): ?>
          <div class="recent-blog-card animate-on-scroll">
            ...
            <a href="blog-detail.php?id=<?= $blog['id'] ?>" class="recent-blog-read-more">Read more</a>
          </div>
        <?php endforeach; ?>
      <?php else: ?>
